...
import cn.wxyx.ygkc2.ui.QueryActivity;
import android.content.Intent;
import android.os.AsyncTask;

public class AsyncTaskScanForCheck extends AsyncTask <Integer, Integer, String>{
...
//	private TextView serveLength;
	public AsyncTaskScanForCheck(MipcaActivityCapture mipcaActivityCapture,
			String fromScan) {
		super();
...
//		String result = service.checkEqu("Type your URL",fromScan);// 调用与服务器通信的接口
//		return result;
	}
...
//			serveLength.setText(loginResult);
			...
			intent.setClass(mipcaActivityCapture, QueryActivity.class);
